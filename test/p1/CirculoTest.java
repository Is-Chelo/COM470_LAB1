...
public class CirculoTest {
	...
	public void mainTestInputmenos1() {
		...
		//(expected) output
                String consoleOutput="Introduzca el radio: "+ System.getProperty("line.separator");
		consoleOutput +="Debe introducir numeros positivos"+ System.getProperty("line.separator");
        ...
        //Caso de uso r="abc"
    @Test
	public void mainTestInputLetras() {
		String input="abc\n";
		ByteArrayInputStream in = new ByteArrayInputStream(input.getBytes());
		System.setIn(in);
		...
		//(expected) output
                String consoleOutput="Introduzca el radio: "+ System.getProperty("line.separator");
		consoleOutput +="Debe Introducir Numeros"+ System.getProperty("line.separator");
